...
@section('content')
                            ...
                            <div
                                ...
                                <div class="show-case">
                                    <div class="hero-slide-image">
                                        <img src="{{asset('fontend/images')}}/slider-image/slider-2-1.png" alt="" />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="container align-self-center">
                        <div class="row">
                            ...
                            <div
                                ...
                                <div class="show-case">
                                    <div class="hero-slide-image">
                                        <img src="{{asset('fontend/images')}}/slider-image/slider-2-2.png" alt="" />
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="single-feature">
                        <div class="feature-icon">
                            <img src="{{asset('fontend/images')}}/icons/1.png" alt="">
                        </div>
                ...
                <div class="col-lg-4 col-md-6 mb-md-30px mb-lm-30px mt-lm-30px">
                    <div class="single-feature">
                        <div class="feature-icon">
                            <img src="{{asset('fontend/images')}}/icons/2.png" alt="">
                        </div>
                        <div class="feature-content">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-feature">
                        <div class="feature-icon">
                            <img src="{{asset('fontend/images')}}/icons/3.png" alt="">
                        </div>
                        <div class="feature-content">
                    ...
                    <div class="tab-content mb-30px0px">
                        ...
                        <div class="tab-pane fade" id="tab-product-{{$category->id}}">
                           ...
                           @forelse (App\Models\Product::where('category_id',$category->id)->get() as $product)
                                ...
                                @empty
                                <div class="col-12">
                                    <div class="alert alert-danger">No product To Show In This Category</div>
                                </div>
                           @endforelse
                            </div>
                        </div>
                        @endforeach
                        <!-- category Product tab end -->
                    </div>
                    @if ($total_product > 8)
    ...
    <div class="banner-area pt-100px pb-100px plr-15px">
        <div class="row m-0">
            @foreach ($categories as $category)
               <div class="d-none col-12 col-lg-4 center-col mb-md-30px mb-lm-30px mb-4 div_category">
         ...
         <a id="loadmore" href="shop-left-sidebar.html" class="btn btn-lg btn-primary btn-hover-dark m-auto"> See More <i
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 mb-md-30px mb-lm-30px">
                    <div class="single-blog">
                        <div class="blog-image">
                            <a href="blog-single-left-sidebar.html"><img src="{{asset('fontend/images')}}/blog-image/1.jpg"
                ...
                <div class="col-lg-4 mb-md-30px mb-lm-30px">
                    <div class="single-blog ">
                        <div class="blog-image">
                            <a href="blog-single-left-sidebar.html"><img src="{{asset('fontend/images')}}/blog-image/2.jpg"
                                    class="img-responsive w-100" alt=""></a>
                        </div>
                        <div class="blog-text">
                            <div class="blog-athor-date">
                ...
                <div class="col-lg-4">
                    <div class="single-blog">
                        <div class="blog-image">
                            <a href="blog-single-left-sidebar.html"><img src="{{asset('fontend/images')}}/blog-image/3.jpg"
                                    class="img-responsive w-100" alt=""></a>
                        </div>
                        <div class="blog-text">
                            <div class="blog-athor-date">
