                        ...
                        <div class="tab-pane fade" id="orders">
                            ...
                            <div class="table_page table-responsive">
                                <table>
                                    ...
                                    <tbody>
                                        @forelse ($order_sumaries as $order)
                                            <tr>
                                                <td>{{ $loop->index + 1 }}</td>
                                                <td>{{ $order->id }}</td>
                                                <td>{{ $order->created_at->format('M d, Y') }}</td>
                                                <td>{{ $order->created_at->addDays(3)->format('M d, Y') }}</td>
                                                <td><span class="success">{{ $order->delivary_status }}</span></td>
                                                <td><span class="success">{{ $order->payment_status }}</span></td>
                                                <td>{{ $order->grand_total }}</td>
                                                <td>
                                                    <a href="{{ route('dashboard.order.invoice', $order->id) }}"
                                                        class="view">view</a>
                                                    <br>
                                                    <a href="{{ route('dashboard.order.invoice.download', $order->id) }}"
