...
<body>
            ...
            <div class="container position-relative">
                <div class="row">
                    ...
                    <div class="col align-self-center d-none d-lg-block">
                        <div class="main-menu">
                            <ul>
                                <li class="dropdown"><a href="{{ route('index') }}">Home</i></a>
                                </li>
                        ...
                        <div class="header-actions">
                            @guest
                                @if (Route::currentRouteName() == 'product.details')
                                    <a href="{{ route('login') }}?previous_page={{ url()->full() }}"
                                        class="header-action-btn login-btn">Sign In</a>
                                @else
                            ...
                            <a href="#offcanvas-cart"
                                ...
                                <span class="header-action-num">{{ total_cart_product() }}</span>
            ...
            <div class="body customScroll">
                <ul class="minicart-product-list">
                    @foreach (cart_products() as $cart_product)
                        <li>
                            <a href="single-product.html" class="image"><img
                                    src="{{ asset('fontend/images') }}/product-image/1.jpg"
                                    alt="Cart product Image"></a>
                            <div class="content">
                                <a href="single-product.html"
                                    class="title">{{ $cart_product->relationwithproduct->product_name }}</a>
                                <span class="quantity-price">{{ $cart_product->user_input_amout }} x <span
                                        class="amount">
                                        @if ($cart_product->relationwithproduct->product_discounted_price)
                                            {{ $cart_product->relationwithproduct->product_discounted_price }}
                                        @else
                                            {{ $cart_product->relationwithproduct->product_regular_price }}
                                        @endif
                                    </span></span>
                                <span class="amount"></span>
                                {{-- {{product_regular_price}} --}}
                                <a href="{{ route('cart.remove', $cart_product->id) }}" class="remove">×</a>
                            </div>
                        </li>
                    @endforeach
                        ...
                        <div class="col-md-6 col-lg-3 mb-md-30px mb-lm-30px">
                            <div class="single-wedge">
                                <div class="footer-logo">
                                    <a href="index.html"><img src="{{ asset('fontend/images') }}/logo/logo-white.png"
                                            alt=""></a>
                                </div>
    ...
    <script>
        $(function() {
            $(".div_category").slice(0, 3).removeClass('d-none');
            $("#loadmore").on('click', function(e) {
                e.preventDefault();
                $(".div_category.d-none").slice(0, 3).removeClass('d-none');
                if ($(".div_category.d-none").length == 0) {
                    $("#loadmore").remove();
                } else {
                    $('html,body').animate({
