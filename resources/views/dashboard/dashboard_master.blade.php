...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('dashboard') }}/vendor/summernote/summernote.css">
    <link href="{{ asset('dashboard') }}/vendor/bootstrap-select/dist/css/bootstrap-select.min.css" rel="stylesheet">
    <link href="{{ asset('dashboard') }}/vendor/owl-carousel/owl.carousel.css" rel="stylesheet">
    <link href="{{ asset('dashboard') }}/css/style.css" rel="stylesheet">
    <link href="{{ asset('dashboard') }}/css/custome.css" rel="stylesheet">
    <link
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
                                    @if (auth()->user()->portfolio_photo)
                                        <img src="{{ asset('uploads/profile_photo') }}/{{ auth()->user()->portfolio_photo }}"
                                            class="img-fluid rounded-circle" alt="Not Found">
                                    @else
                                        <img src="{{ asset('dashboard') }}/images/profile/17.jpg" width="20"
                                            alt="" />
                                    @endif
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a href="href=" {{ route('logout') }}" class="dropdown-item ai-icon"
        ...
        <div class="deznav">
            <div class="deznav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    {{-- Sub category Menu Bar end --}}

                    {{-- Variatin manager Menu Bar start --}}
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                    ...
                    {{-- Variatin manager Menu Bar end --}}

                    {{-- Product section Menu Bar start --}}
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                    ...
                    {{-- Product section Menu Bar end --}}

                    {{-- Werbsite Menu Bar end --}}
                    ...
                    <li><a href="{{ route('coupon.index') }}" class="ai-icon" aria-expanded="false">
                            ...
                            <span class="nav-text">Cupon</span>
                        </a>
                    </li>
                    {{-- Cupon Menu Bar end --}}

                    {{-- Oreder Menu Bar end --}}
                    <li><a href="{{ route('order.info') }}" class="ai-icon" aria-expanded="false">
                            <i class="fa fa-cubes"></i>
                            <span class="nav-text">Oreder Info</span>
                        </a>
                    </li>
                    {{-- Oreder Menu Bar end --}}
